...
const TRANSLATIONS = {
  ...
  ru: {
    ...
    email_not_verified: "Пожалуйста, сначала подтвердите свой email",
  ...
  ka: {
    ...
    email_not_verified: "გთხოვთ ჯერ დაადასტურეთ ელფოსტა",
    account_inactive: "ანგარიში არააქტიური",
    login_success: "შესვლა წარმატებული"
  }
};
  ...
  try {
    ...
    if (!user) {
      return new Response(JSON.stringify({ 
        error: t('user_not_found', language) 
